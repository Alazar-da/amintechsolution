...
<nav className='hidden md:grid md:grid-cols-3 md:gap-4 w-full' id='menu'>
  <ul class="md:flex md:col-span-2 md:justify-center md:items-center">
    <li className="md:mx-[35px] lg:mx-[40px]">
      <a className="block no-underline hover:underline py-2 text-primary text-base font-bold hover:text-[#0b476c] md:border-none md:p-0" href={home}>
        Home
      </a>
    </li>
    <li className="md:mx-[15px] lg:mx-[30px]">
      <a  className="border-t block no-underline hover:underline py-2 text-primary text-base font-bold hover:text-[#0b476c] md:border-none md:p-0" href={service}>
        Services
      </a>
    </li>
    <li className="md:mx-[15px] lg:mx-[30px]">
      <a className="border-t block no-underline hover:underline py-2 text-primary text-base font-bold hover:text-[#0b476c] md:border-none md:p-0" href={team}>
        Team
      </a>
    </li>
    <li className="md:mx-[15px] lg:mx-[30px]">
      <a className="border-t block no-underline hover:underline py-2 text-primary text-base font-bold hover:text-[#0b476c] md:border-none md:p-0" href={portfolio}>
        Portfolio
      </a>
    </li>
  </ul>
