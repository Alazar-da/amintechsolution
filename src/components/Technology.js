...
function Technology() {
    return(
      ...
      <h2 className="text-3xl font-bold text-blue-500 italic mb-4 animate-charcter">Technology we use</h2>
  ...
  <div className="grid grid-cols-4 gap-4 mt-4">
    ...
    <div className="flex flex-col items-center">
      ...
      <h3 className="font-bold text-green italic text-center mt-2">Vue</h3>
    </div>
    <div className="flex flex-col items-center">
      <Angular className="w-8 h-8" />
      <h3 className="font-bold text-red italic text-center mt-2">Angular</h3>
    </div>
    <div className="flex flex-col items-center">
      <Js className="w-8 h-8" />
      <h3 className="font-bold text-yellow italic text-center mt-2">Javascript</h3>
    </div>
  </div>
</div>
...
<div className="m-4">
  ...
  <div className="grid grid-cols-4 gap-4 mt-4">
    ...
    <div className="flex flex-col items-center">
      ...
      <h3 className="font-bold text-green italic text-center mt-2">Node JS</h3>
    </div>
    <div className="flex flex-col items-center">
      <Django className="w-8 h-8" />
      <h3 className="font-bold text-green italic text-center mt-2">Django</h3>
    </div>
  </div>
</div>
...
<div className="m-4">
  ...
  <div className="grid grid-cols-4 gap-4 mt-4">
    ...
    <div className="flex flex-col items-center">
      ...
      <h3 className="font-bold text-red italic text-center mt-2">Adobe</h3>
    </div>
    <div className="flex flex-col items-center">
...
<div className="m-4">
  ...
  <div className="grid grid-cols-4 gap-4 mt-4">
    ...
    <div className="flex flex-col items-center">
      ...
      <h3 className="font-bold text-red italic text-center mt-2">iOS</h3>
    </div>
    <div className="flex flex-col items-center">
      <Nativ className="w-8 h-8" />
      <h3 className="font-bold text-blue italic text-center mt-2">React Native</h3>
    </div>
  </div>
</div>
      </main>
