      ...
      <main className=" flex flex-col content-center bg-third py-5 mt-7" id='services'>
         ...
         <div className='flex flex-col md:flex-row items-center gap-4 mt-5'>
            <div className='sm:w-4/5 w-5/6 md:w-full'>
               ...
               <div>
                  <h2 className='text-2xl pt-4'>UI/UX Design</h2>
                  <p className="text-1xl text-textColor pt-2 pb-3">Our dedicated UI/UX designers craft intuitive and visually appealing user interfaces that enhance the overall user experience of your digital products. We follow a user-centric design approach, conducting thorough research and usability testing to ensure that your applications are not only aesthetically pleasing but also highly user-friendly.</p>
            ...
            <div className='sm:w-4/5 w-5/6 md:w-full'>
               ...
               <div>
                  <h2 className='text-2xl pt-4'>Web Development</h2>
                  <p className="text-1xl text-textColor pt-2 pb-3">Our expert team designs and develops visually stunning and highly functional websites tailored to meet your business objectives. We create responsive and user-friendly websites that provide an exceptional user experience across all devices and browsers. websites that provide an exceptional user experience across all devices and browsers.</p>
            ...
            <div className='sm:w-4/5 w-5/6 md:w-full'>
               ...
               <div>
                  <h2 className='text-2xl pt-4'>Mobile Application</h2>
