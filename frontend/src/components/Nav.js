...
import Logo from '../img/mina4.jpg';
 ...
 <h1 className="leading-none text-2xl text-grey-darkest">
  <a className="no-underline text-grey-darkest hover:text-black" href={home}>
    <img 
      src={Logo} 
      alt='logo' 
      className='h-16 rounded-full p-1 border-2 border-gray-200 hover:border-gray-300 transition-all'
...
<div className='border-t md:border-none md:flex md:justify-center md:items-center py-2 hidden' id='menu2'>
    ...
    <button className="btn-cssbuttons">
            ...
            <li>
              <a target="_blank" href="https://www.instagram.com/minatechnologies?igsh=bG82ejVvYXZyNzR0">   <svg height="18" width="18" xmlns="http://www.w3.org/2000/svg"  fill="#fff" className="bi bi-instagram" viewBox="0 0 16 16">
